...
import { addRecord, updateRecords, deleteRecord, setSearchTerm, resetAllRecords, selectAllRecord,  selectSearchTerm } from '../store/recordSlice'
    ...
    <div className='min-h-screen bg-gray-100 p-6'>
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                {/* Footer Showing Filtered vs Total Result */}
